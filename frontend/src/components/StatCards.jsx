import { Activity, FilePlus2, ArrowLeftRight, Trash2, ShieldAlert } from 'lucide-react'

export default function StatCards({ stats }) {
  const cards = [
    { key: 'clean',    icon: <Activity size={18} />,      label: '전체 이벤트',      value: stats.total },
    { key: 'clean',    icon: <FilePlus2 size={18} />,     label: '생성',             value: stats.created },
    { key: 'warn',     icon: <ArrowLeftRight size={18} />,label: '파일 교체',        value: stats.moved },
